...
function Command({
  ...
  return (
    <CommandPrimitive
      data-slot="command"
      className={cn(
        "flex size-full flex-col overflow-hidden rounded-xl! bg-popover p-2 text-popover-foreground",
        className
      )}
      {...props}
    />
...
function CommandInput({
  ...
  return (
    <div data-slot="command-input-wrapper" className="border-b border-border/60 p-3">
      <InputGroup className="h-11! rounded-lg! border-transparent! bg-transparent! shadow-none! *:data-[slot=input-group-addon]:pl-1!">
        <InputGroupAddon>
          <SearchIcon className="size-4.5 shrink-0 opacity-50" />
        </InputGroupAddon>
...
function CommandList({
  ...
  return (
    <CommandPrimitive.List
      ...
      className={cn(
        "no-scrollbar max-h-80 scroll-py-1 overflow-x-hidden overflow-y-auto outline-none pb-1",
        className
      )}
      {...props}
    />
